...
<head>
    ...
    <!-- End SEO tag -->
    <!-- FAVICONS -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets/apple-touch-icon.png.htm">
    <link rel="shortcut icon" href="assets/favicon.ico.htm">
                ...
                <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                    ...
                    <ul class="header-nav nav">
                        ...
                        <li class="nav-item dropdown header-nav-dropdown has-notified">
                            <a class="nav-link" href="index.htm#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <span>Activities
                        <span class="badge">(2)</span>
                                ...
                                <div class="dropdown-scroll has-scrollable">
                                    <!-- .dropdown-item -->
                                    <a href="index.htm#" class="dropdown-item unread">
                                    ...
                                    <!-- /.dropdown-item -->
                                    <!-- .dropdown-item -->
                                    <a href="index.htm#" class="dropdown-item">
                                        <div class="user-avatar">
                        ...
                        <li class="nav-item dropdown header-nav-dropdown has-notified">
                            ...
                            <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                                <h6 class="dropdown-header stop-propagation">
                                    <span>Messages</span>
                                    <a href="index.htm#">Mark all as read</a>
                                </h6>
                                <!-- .dropdown-scroll -->
                                <div class="dropdown-scroll has-scrollable">
                                    <!-- .dropdown-item -->
                            ...
                            <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                                ...
                                <div class="dropdown-sheets">
                                    ...
                                    <div class="dropdown-sheet-item">
                                        <a href="index.htm#" class="tile-wrapper">
                  ...
                  <span class="user-avatar">
                    ...
                    <span class="account-description">Marketing Manager</span>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="index.htm#">Help Center</a>
                            <a class="dropdown-item" href="index.htm#">Ask Forum</a>
                            <a class="dropdown-item" href="index.htm#">Keyboard Shortcuts</a>
                        </div>
                        <!-- /.dropdown-menu -->
                    </div>
                    <!-- /.btn-account -->
            ...
            <div class="page">
                ...
                <div class="page-inner">
                    ...
                    <div class="page-section">
                        ...
                        @component('card',['title'=>'Select  Role'])
                            <div class="row">
                                <div class="col align-self-center">
                            <form class="text-center" method="POST" action="{{route('selectRoleList')}}">
                                @csrf
...
<script async src="../www.googletagmanager.com/gtag/js-id=UA-116692175-1.htm"></script>
<script>
